...
Simple run the Hydra-Installer.exe setup file. The Packet has own Uninstallator.

Note: See Installer in Release Section

Installer Set the Variable HYDRA for Quick access to catalog with program
